...
do
	...
	#do
		...
		#echo ./mallet-2.0.7/bin/mallet train-topics --num-topics $NUM_OF_TOPICS --num-threads 10  --input $OUTPUT_FOLDER/$corpus\_train.in.mallet --output-model $OUTPUT_FOLDER/mallet_pam_$NUM_OF_TOPICS\_$super_topic/pam_model.output --use-pam --pam-num-supertopics $super_topic	
	#done
done		
